...
for (let i = 0; i < 10; i++) {
  if (i % 2 === 0) {
    console.log(i) // Imprime los números del 0 al 9 que son pares
  }
}
...
for (let i = 1; i <= 10; i++) {
  if (i < 10) {
    console.log('Intentando dormir 🐑') // Muestra el mensaje en las primeras 9 vueltas
  } else {
    console.log('Dormido!') // Cambia el mensaje en la vuelta 10
  }
}
